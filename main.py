...
# public google drive url to load dataset
aft_url = 'https://drive.google.com/file/d/1OS_ZGwwXM0AKzNyKvAZ-jI-KfD8uppce/view?usp=sharing'
cph_url = 'https://drive.google.com/file/d/1Heo3fLK-bhPU0reSS2lLdWZ17qw3T6MV/view?usp=drive_link'
rsf_url = 'https://drive.google.com/file/d/1LS5LTUk5UXPMQfd8vXQ3Jy75Gi_9GURQ/view?usp=drive_link'
train_aft_url = 'https://drive.google.com/file/d/1-5hGscFQrPi5mxLGb4wZlBGH6Vcugoc9/view?usp=drive_link'
train_cph_url = 'https://drive.google.com/file/d/1-5bHYH_-Fe06pX59gejW5p1pA75TPoCH/view?usp=drive_link'
train_rsf_url = 'https://drive.google.com/file/d/1-1DpRF_u5Y5Ijcyk_6nceVrLP4AloJAU/view?usp=drive_link'
train_median_url = 'https://drive.google.com/file/d/1-9bhUI7SYBeXKRV7QsW6xc2_A3o67aQc/view?usp=drive_link'

aft_path = 'https://drive.google.com/uc?export=download&id=' + aft_url.split('/')[-2]
cph_path = 'https://drive.google.com/uc?export=download&id=' + cph_url.split('/')[-2]
rsf_path = 'https://drive.google.com/uc?export=download&id=' + rsf_url.split('/')[-2]
train_aft_path = 'https://drive.google.com/uc?export=download&id=' + train_aft_url.split('/')[-2]
train_cph_path = 'https://drive.google.com/uc?export=download&id=' + train_cph_url.split('/')[-2]
train_rsf_path = 'https://drive.google.com/uc?export=download&id=' + train_rsf_url.split('/')[-2]
train_median_path = 'https://drive.google.com/uc?export=download&id=' + train_median_url.split('/')[-2]


def load_by_unpickling(url):
    data = cp.load(urlopen(url))
    return data

aft = load_by_unpickling(aft_path)
cph = load_by_unpickling(cph_path)
rsf = load_by_unpickling(rsf_path)

train_aft = pd.read_csv(train_aft_path)
train_cph = pd.read_csv(train_cph_path)
train_rsf = pd.read_csv(train_rsf_path)
train_median = pd.read_csv(train_median_path)

# when using local files...
#aft = pickle.load(open('C:/Users/hyji1/Desktop/1108_web_deploy/data/aft_1109.pkl', 'rb'))
#cph = pickle.load(open('C:/Users/hyji1/Desktop/1108_web_deploy/data/cph_1109.pkl', 'rb'))
#rsf = pickle.load(open('C:/Users/hyji1/Desktop/1108_web_deploy/data/rsf_1109.pkl', 'rb'))

#train_aft = pd.read_csv('C:/Users/hyji1/Desktop/1108_web_deploy/data/train_aft_1109.csv')
#train_cph = pd.read_csv('C:/Users/hyji1/Desktop/1108_web_deploy/data/train_cph_1109.csv')
#train_rsf = pd.read_csv('C:/Users/hyji1/Desktop/1108_web_deploy/data/train_rsf_1109.csv')
#train_median = pd.read_csv('C:/Users/hyji1/Desktop/1108_web_deploy/data/train_median_1109.csv')
